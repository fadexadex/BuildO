...
const PTAU_PATH = path.join(PTAU_DIR, 'powersOfTau28_hez_final_10.ptau');

// File size for reference: ~16 MB
const EXPECTED_SIZE = 16777296;
...
const downloadPtau = async () => {
  try {
    console.log('========================================');
    console.log('Powers of Tau Download');
    console.log('========================================');
    console.log('');
    ...
    console.log('');
    console.log('You can now generate ZK proofs!');
    console.log('');
